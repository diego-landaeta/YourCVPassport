...
export const translations = {
    ...
    howItWorks: {
        ...
        ctaSubtext: 'No credit card required \u2022 Setup in 5 minutes',
    },
    testimonials: {
    ...
    customDomain: {
        ...
        heroImageAlt: 'Custom Domain for Your CV',
        ...
        inlineCta: {
            title: 'Reserve your custom URL',
            description: 'Create your professional personal brand with a memorable URL that stands out to recruiters.',
            button: 'Set up my URL now'
        },
    ...
    stampsPage: {
        ...
        heroImageAlt: 'Blockchain Credential Verification'
    },
    atsPage: {
        ...
        heroImageAlt: 'ATS-Optimized Templates',
        cta: {
        ...
        inlineCta: {
            title: 'Optimize your CV for ATS now',
            description: 'Access professional templates optimized for ATS systems and increase your chances of being contacted.',
            button: 'Try ATS templates free'
        },
        finalCta: {
    ...
    homePage: {
        seo: {
            title: 'Verified Professional CV',
            description: 'Create your verified professional CV that recruiters trust. AI optimization, ATS-compatible, global visibility. Join over 10,000 professionals with YourCVPassport.',
        },
        inlineCta1: {
            title: 'Ready to stand out?',
            description: 'Join thousands of professionals who have already created their verified profile and receive job opportunities every week.',
            button: 'Create my free profile',
        },
        inlineCta2: {
            title: 'Start today, free',
            description: 'Create your professional profile in minutes. No credit card required.',
            button: 'Sign up now',
        },
    },
    aiPage: {
        seo: {
            title: 'AI Assistant for CV',
            description: 'Optimize your CV with artificial intelligence. Automatic description enhancement, ATS keyword suggestions, personalized cover letter generator with YourCVPassport.',
        },
        heroImageAlt: 'AI Assistant for CV',
        inlineCta: {
            title: 'Let AI work for you',
            description: 'Optimize your CV automatically and generate personalized cover letters in seconds.',
    ...
    analyticsPage: {
        ...
        heroImageAlt: "Professional Profile Analytics",
        inlineCta: {
            title: "Start tracking your metrics today",
            description: "Get detailed insights into who visits your profile and optimize your job search strategy.",
            button: "Activate free analytics"
        }
    },
    libraryPage: {
    ...
    statusPage: {
        ...
        incidentHistorySubtitle: "Complete history of incidents, maintenance, and system updates",
        incident3: {
            title: "OAuth Authentication Error",
            date: "October 15, 2025",
            duration: "Duration: 2 hours",
            description: "Issue with the OAuth authentication provider that prevented some users from logging in. Resolved by updating credentials and renewing SSL certificates."
        },
        incident4: {
            title: "Security Update v2.1.0",
            date: "October 5, 2025",
            window: "Window: 01:00 - 03:30 UTC",
            description: "Deployment of critical security patches and blockchain verification system update. End-to-end data encryption improvements."
        },
        incident5: {
            title: "PDF Generation Slowness",
            date: "September 20, 2025",
            duration: "Duration: 1 hour 15 minutes",
            description: "Performance degradation in the CV PDF generation service. Server resources were scaled up and the rendering process was optimized."
        },
        incident6: {
            title: "Database Migration",
            date: "September 5, 2025",
            window: "Window: 00:00 - 05:00 UTC",
            description: "Successful migration to new database infrastructure with increased capacity and redundancy. Significant improvement in response times (40% reduction)."
        },
        incident1Duration: "Duration: 45 minutes",
        incident1Desc: "An issue with temporary API latency was identified and resolved, affecting a subset of users in the EU-West region.",
        incident2Window: "Window: 02:00 - 04:00 UTC",
        incident2Desc: "Scheduled infrastructure update to improve performance and security. New database optimizations were implemented."
    },
    missionPage: {
    ...
    contactPage: {
        ...
        form: {
            ...
            errorMessage: "There was an error sending your message. Please try again or contact us directly via email.",
            sending: "Sending..."
        },
        office: {
    ...
    successStoriesPage: {
        seo: {
            ...
            description: 'Read real stories of professionals who got jobs using our CV templates. Verified transformations and proven results with YourCVPassport.',
        },
        ...
        stats: {
            hires: '5,000+ Hires',
            hiresLabel: 'from our platform',
            promotion: '3x Increased',
            promotionLabel: 'in promotion rate',
            timeSaved: '50% Time Saved',
            timeSavedLabel: 'in hiring time for recruiters'
        },
        filters: {
    ...
    dashboard: {
        ...
        analyticsPreview: {
            ...
            visitsLast7Days: "Visits in the last 7 days",
            visits: "visits",
            days: {
                mon: "Mon", monFull: "Monday",
                tue: "Tue", tueFull: "Tuesday",
                wed: "Wed", wedFull: "Wednesday",
                thu: "Thu", thuFull: "Thursday",
                fri: "Fri", friFull: "Friday",
                sat: "Sat", satFull: "Saturday",
                sun: "Sun", sunFull: "Sunday",
            },
        },
        newUserWelcome: {
        ...
        modernView: {
            welcomeFirstLogin: (name?: string, _gender?: string) => name ? `Welcome, ${name}!` : 'Welcome!',
            welcomeNoName: (_gender?: string) => 'Welcome!',
            features: {
                professionalCVs: 'Professional CVs',
                professionalCVsDesc: 'Create CVs with modern ATS-optimized templates',
                credentialVerification: 'Credential Verification',
                credentialVerificationDesc: 'Get verified stamps that validate your experience',
                customURL: 'Custom URL',
                customURLDesc: 'Share your profile with a unique professional URL',
                realTimeAnalytics: 'Real-Time Analytics',
                realTimeAnalyticsDesc: 'Track who visits your profile and from where',
            },
            quickStartGuide: {
                title: 'Quick Start Guide',
                description: 'Follow these steps to create your verified professional CV in minutes:',
                step1Title: 'Complete your basic information',
                step1Desc: 'Name, professional title, photo and summary (5 min)',
                step2Title: 'Add your experience and education',
                step2Desc: 'At least 1 work experience and 1 academic background',
                step3Title: 'Define your key skills',
                step3Desc: 'Minimum 3 technical or professional skills',
                step4Title: 'Choose your template and URL',
                step4Desc: 'Select design and create your custom URL',
                tip: 'Tip: Complete all wizard steps to unlock all dashboard features.',
            },
            statsPreview: {
        ...
        opportunities: {
            ...
            myApplicationsDescription: "Complete tracking of your applications with updated statuses",
            searchJobs: "Search Jobs",
            searchJobsDescription: "Find personalized offers and manage your favorites",
            tabRecommended: "Recommended",
            tabAllJobs: "All Jobs",
            tabSaved: "Saved",
            tabApplications: "My Applications",
            tabAll: "All",
            descRecommended: "Best matching jobs for your profile",
            descAllJobs: "Explore all available positions",
            descSaved: "Jobs you saved for later review",
            descApplications: "Track your job applications",
            ...
            jobsFound: (count: number) => `job${count !== 1 ? 's' : ''} found`,
            noJobsFound: "No jobs found",
            noJobsFoundDescription: "Try adjusting your search filters or broaden the criteria",
            noApplications: "No applications",
            noApplicationsWithStatus: "No applications with this status",
            noApplicationsYet: "You haven't applied to any jobs yet",
            noRecommendations: "No recommendations available",
            noRecommendationsDescription: "We didn't find jobs matching your profile right now. Explore all available positions or try again later.",
            noSavedJobs: "No saved jobs",
            noSavedJobsDescription: "Save interesting jobs to review them later",
            ...
            viewedByCompany: "Viewed by company",
            appliedAgo: "Applied",
            daysLabel: "days ago",
            recommendedJobs: "Recommended Jobs",
            recommendedJobsDescription: (count: number) => `We found ${count} jobs with high compatibility with your profile`,
            errorLoadingJobs: "Error loading jobs",
            errorLoadingRecommendations: "Error loading recommendations",
            errorLoadingSavedJobs: "Error loading saved jobs",
            errorSavingJob: "Error saving job",
            errorRemovingSavedJob: "Error removing saved job",
            errorLoadingApplications: "Error loading applications",
            jobRemoved: (title: string) => `"${title}" removed`,
            jobSaved: (title: string) => `"${title}" saved`,
            jobRemovedFromSaved: (title: string) => `"${title}" removed from saved`,
            loadingJobs: "Loading jobs...",
            loadingApplications: "Loading your applications...",
            loadingRecommendations: "Finding best matches...",
        ...
        analytics: {
            ...
            title: "Profile Analytics",
            subtitle: "Statistics and metrics of your professional profile",
            exportCSV: "Export CSV",
            lastDays: (d: number) => `Last ${d} days`,
            totalViews: "Total Views",
            uniqueVisitors: "Unique Visitors",
            ctaClicksLabel: "CTA Clicks",
            ctr: "CTR",
            ...
            topCTAs: "Most Clicked CTAs",
            type: "Type",
            label: "Label",
            loading: "Loading analytics...",
            noData: {
                title: "No analytics data yet",
                description: "Share your professional profile to start collecting statistics on visits, clicks and engagement",
                discoverTitle: "Discover valuable information:",
                items: [
                    "Number of visits and unique visitors",
                    "Countries and cities of origin",
                    "Devices used (mobile, desktop)",
                    "Interactions with your contact buttons",
                ],
                viewProfile: "View my public profile",
                dataWillAppear: "Data will appear when someone visits your profile",
            },
            noActivity: {
                title: "No activity yet",
                description: "Your profile is ready, now you just need to share it to start seeing statistics",
                comingSoon: "Coming soon:",
                items: [
                    "Daily visit trends",
                    "Geographic location of your visitors",
                    "Traffic sources (social media, search, direct)",
                    "Click-to-contact conversion rate",
                ],
                shareProfile: "Share my profile",
                shareVia: "Share on LinkedIn, social media or via email",
            },
            companyWidget: {
                ...
                viaLinkedIn: "Via LinkedIn",
                googleSearch: "Google Search",
                viewedProfile: "Viewed profile",
                minutesAgo: (n: number) => `${n} minutes ago`,
                hoursAgo: (n: number) => `${n} hours ago`,
                daysAgo: (n: number) => `${n} days ago`,
                topCountries: "Top 5 Interested Countries",
                noCountryData: "No country data available yet",
                premiumTitle: "Premium Feature",
                premiumDescription: "Discover which companies viewed your profile, where they're from, advanced analytics and real-time notifications",
                features: {
                    identifyVisitors: "Identify visitors",
                    identifyVisitorsDesc: "See exact locations, cities and countries",
                    realTimeActivity: "Real-time activity",
                    realTimeActivityDesc: "Get instant alerts for new profile views",
                    geoAnalysis: "Geographic analysis",
                    geoAnalysisDesc: "Top 5 countries most interested in your profile",
                    trafficSources: "Traffic sources",
                    trafficSourcesDesc: "Discover where they come from: LinkedIn, Google, etc.",
                    monthGrowth: "Month-over-month growth",
                    monthGrowthDesc: "Percentage growth of your visibility",
                    completeHistory: "Complete history",
                    completeHistoryDesc: "Unlimited access to all your historical activity",
                },
                upgradeToPremium: "Upgrade to Premium",
                pricing: "From €15/mo • Cancel anytime",
            },
        },
        stamps: {
            ...
            availableTitle: "Available Verifications",
            cards: {
                identity: { title: "Identity", description: "Verify your identity with ID or passport" },
                education: { title: "Education", description: "Verify your academic degrees and diplomas" },
                language: { title: "Languages", description: "Verify language certificates (TOEFL, IELTS, DELE, DELF, etc.)" },
                email: { title: "Email", description: "Verify your email address" },
                employment: { title: "Employment", description: "Verify your work experience" },
                certification: { title: "Certifications", description: "Verify your professional certifications" },
            },
            requiresDocument: "Document upload required",
            limitReached: "Limit reached",
            maxAttemptsUsed: "You have used all 4 available attempts",
            availableIn: (days: number) => `Available in ${days} day${days !== 1 ? 's' : ''}`,
            requestEvery3Days: "You can request this verification every 3 days",
            attemptsRemaining: (remaining: number) => `Attempts remaining: ${remaining}/4`,
            requestVerification: "Request Verification",
            monthlyUsage: "Verifications this month:",
            fewRemaining: "Few verifications left!",
            ...
            deleteTitle: "Delete Verification",
            deleteConfirm: "Are you sure?",
            deleteMessage: "Are you sure you want to delete this pending verification? This action cannot be undone.",
            cancel: "Cancel",
            deleting: "Deleting...",
            delete: "Delete",
            deleteSuccess: "Verification deleted successfully",
            deleteError: (msg: string) => `Error deleting verification: ${msg}`,
            waitMessage: (days: number, type: string) => `You must wait ${days} more day${days !== 1 ? 's' : ''} to request another ${type} verification.`,
            deletePendingTitle: "Delete pending verification",
        },
        cvBuilder: {
        ...
        export: {
            ...
            sectionDescription: "Download and share your professional CV in multiple formats. Choose the best option based on your needs: PDF with full design for presentations, ATS-optimized PDF for job applications through automated systems, JSON for data backup, or a public link to share your always-updated CV online.",
            monthlyLimit: "Monthly Export Limit",
            limitReached: "You have reached your monthly limit. Upgrade for unlimited exports.",
            remaining: (remaining: number, limit: number) => `${remaining} of ${limit} exports remaining this month`,
            upgradePlan: "Upgrade Plan",
            unlimitedExports: "Unlimited Exports",
            unlimitedDescription: "Export your CV as many times as you need",
            cancel: "Cancel",
            pdf: {
                title: "Export PDF",
                description: "Download your CV in PDF format with your selected template design. Perfect for printing and email attachments. Includes colors and graphics from your chosen template.",
                button: "Download PDF",
            ...
            json: {
                title: "Export JSON",
                description: "Export all your profile data in JSON format. Ideal for developers, data backups, or importing into other systems. Includes all sections: experience, education, skills, and more.",
            ...
            ats: {
                ...
                description: "Optimized PDF for Applicant Tracking Systems (ATS) used by HR departments. Simple formatting ensures your CV is properly parsed by automated systems. Choose from 3 professional templates designed to pass ATS screening.",
                button: "Export ATS PDF",
                compatible: "ATS Compatible",
                templates: "3 Templates",
            },
            publicLink: "Public Link",
            publicLinkDescription: "Share your CV with a personalized public link. Perfect for adding to email signatures, LinkedIn profiles, or sharing with recruiters. Your CV will be displayed with your selected template and always up-to-date.",
            easyShare: "Easy Share",
        ...
        share: {
            ...
            sectionDescription: "Share your professional CV with recruiters, colleagues, and on social networks. Use your personalized public link, share on LinkedIn, Twitter, or embed your CV on your website. Your CV will always display the latest information and your selected design template.",
            publicLink: "Public Link",
        ...
        analyticsPanel: {
            ...
            ctaClicksMetric: "CTA Clicks",
            leadsGenerated: "Leads Generated",
            conversionRate: "Conversion Rate",
            lastPeriod: (range: string) => `Last ${range}`,
        ...
        visas: {
            ...
            deleteTitle: "Delete Visa?",
            deleteMessage: "This action cannot be undone. Are you sure you want to delete this visa?",
            deleteButton: "Delete",
            cancelButton: "Cancel",
            noPermission: "You do not have permission to perform this action",
            saveError: "Error saving visa",
            present: "Present",
            metrics: "metrics",
        },
        tour: {
        ...
        templatePreview: {
            ...
            all: "All",
            free: "Free",
            unlockPro: "Unlock all PRO templates",
            accessPremium: (count: number) => `Access ${count}+ professionally designed premium templates`,
        ...
        settings: {
            ...
            sectionDescription: "Configure your account preferences, display settings, and privacy options. Customize your CV visibility, manage your custom domain, update your personal information, and control how recruiters and visitors interact with your profile.",
        ...
        businessCard: {
            ...
            downloadPDF: "Download PDF",
            downloadDescription: "Download your digital business card with QR code that matches your CV style",
        },
        businessCardGallery: {
            currentCard: "Your Current Card",
            businessCardLabel: "Business Card",
            qrError: "Error generating QR code",
            saveError: "Error saving card selection",
            saveCardError: "Error saving business card",
            designGallery: "Design Gallery",
            exploreAllCards: "Explore All Business Cards",
            galleryDescription: "Each design matches perfectly with your CV style. Your card updates automatically when you change templates.",
            filterAll: "All",
            filterFree: "Free",
            savingCard: "Saving card...",
            proTip: "Pro Tip",
            proTipDescription: "Click on any card to select it. You can choose a different design from your CV.",
        },
        messaging: {
            userFallback: "User",
        ...
        versionModal: {
            ...
            editSubtitle: "Customize your CV for different needs",
            newSubtitle: "Create a personalized version of your CV",
            basicInfo: "Basic Information",
            versionNameLabel: "Version name *",
            versionNamePlaceholder: "e.g., CV USA - Frontend Developer",
            ...
            freeAndPro: "10 free + 10 PRO",
            sections: "Sections",
            selectedCount: (n: number) => `${n} selected`,
            order: "Order",
            dragToReorder: "Drag to reorder",
            notesLabel: "Notes (optional)",
            notesPlaceholder: "Add internal notes (e.g., 'No photo for US')...",
            cancel: "Cancel",
            updating: "Updating...",
            creating: "Creating...",
            update: "Update",
            ...
            selectAtLeastOne: "You must select at least one section",
            updateError: "Error updating version",
            ...
            sectionDescriptions: {
                profile: "Basic information and summary",
        ...
        welcomeModal: {
            welcomeUser: (name?: string, _gender?: string) => `Welcome${name ? `, ${name}` : ''}!`,
            description: 'To access all features of your professional dashboard, you first need to complete your profile.',
            featuresIntro: 'Once you complete your profile, you will be able to:',
            featureCustomizeCV: 'View and customize your professional CV',
            featureExportPDF: 'Export your CV in PDF format',
            featureShareProfile: 'Share your profile with recruiters',
            featureViewAnalytics: 'View analytics of visits and clicks',
            featureManageLeads: 'Receive and manage company leads',
            estimatedTime: 'Estimated time: 5-10 minutes',
            estimatedTimeDescription: 'Complete your basic information step by step. You can save and continue later if needed.',
            completeProfileNow: 'Complete my profile now',
            later: 'Later',
        },
        usageStats: {
            title: 'Plan Usage',
            ...
            used: 'used',
            remaining: 'remaining',
            atsExportName: 'ATS Exports',
            atsExportDescription: 'PDF/DOCX this month',
            aiRequestName: 'AI Requests',
            aiRequestDescription: 'Text improvements',
            verificationsName: 'Verifications',
            verificationsDescription: 'Stamps requested',
            periodInfo: 'Resets monthly',
    ...
    howItWorksPage: {
        ...
        inlineCta: {
            ...
            description: "Follow these steps and you will have your verified professional profile in less than 10 minutes.",
            button: "Start now"
        },
    ...
    templatesAndExamplesPage: {
        ...
        description: "Templates designed by HR experts, optimized for ATS systems like Greenhouse, Lever, and Workday. Customizable in real-time and exportable to high-quality PDF.",
        templatesIncluded: "CVs, Cover Letters, Emails & More",
        heroImageAlt: "Professional CV Templates",
        gallery: {
            title: "Explore Our Templates",
            subtitle: "Find the perfect design to match your personal brand.",
            description: "Each template includes sections for professional experience, education, technical skills, languages, and featured projects. Change colors, fonts, and reorganize content with our drag-and-drop editor. All compatible with ATS systems to ensure your CV is correctly processed by recruiters.",
            categories: [
                { key: 'All', name: 'All' },
                { key: 'CV', name: 'CVs' },
        ...
        successStories: {
            ...
            description: "The difference between a generic CV and a professionally designed one can determine your success in the job search. A clean and structured design significantly increases the chances of your CV being fully read and capturing the attention of recruiters from the first glance.",
        ...
        customize: {
            ...
            description: "An intuitive visual editor that lets you modify every element in real-time. Change fonts, adjust margins, reorganize sections with drag-and-drop, and visualize changes instantly. All without needing technical or graphic design skills.",
            features: [
        ...
        comparison: {
            ...
            subtitle: "Compare the advantages of our professional templates versus basic tools.",
        ...
        inlineCta: {
            ...
            description: "Access all our professional ATS-optimized templates and start standing out today.",
    ...
    advancedTalentSearch: {
        ...
        filters: {
            ...
            locationHint: "City or specific region",
        },
        heroImageAlt: "Advanced Talent Search",
        interfaceSubtitle: "Find the perfect talent for your team with advanced filters",
        loadingProfiles: "Loading profiles...",
        noResultsTitle: "No profiles found",
        noResultsSubtitle: "Try adjusting the search filters or broadening your criteria",
        clearFilters: "Clear Filters",
        ...
        refresh: "Refresh",
        loadMore: "Load More",
        showingOf: "Showing {current} of {total} profiles",
        aiMatching: {
    ...
    atsIntegrationsPage: {
        ...
        inlineCta: {
            title: "Connect with any ATS",
            description: "Export your optimized CV directly to the most popular ATS systems without losing format or information.",
            button: "See available integrations"
        },
        finalCta: {
    ...
    securityCompliancePage: {
        ...
        heroImageAlt: "Security and Compliance",
        inlineCta: {
            title: "Protect your professional information",
            description: "Join thousands of professionals who trust our certified platform to manage their information securely.",
            button: "Create secure profile"
        }
    },
    blogPage: {
    ...
    aiQuestionnaire: {
        ...
        common: {
            add: 'Add',
            proficiencyLevelPercent: 'Proficiency Level (%)',
        ...
        identity: {
            ...
            summaryDescription: 'Describe your professional profile in a few words'
        },
        experience: {
            label: 'Experience',
            position: 'Position',
        ...
        languages: {
            ...
            levelNative: 'Native',
            heading: 'Languages',
            subtitle: 'Indicate the languages you speak'
        },
        preferences: {
            ...
            subtitle: 'Indicate your work preferences',
        ...
        template: {
            ...
            subtitle: 'Select the design that best represents your professional style',
            premiumDescription: 'Premium design with advanced features',
            standardDescription: 'Professional and elegant design'
        },
        messages: {
    ...
    profileEditor: {
        ...
        skills: {
            ...
            typeToSeeSuggestions: 'Type to see suggestions',
            popularSuggestions: 'Popular suggestions - Click to select',
            customSkillTip: 'Tip: You can also write custom skills',
            notSpecified: 'Not specified',
            actionCannotBeUndone: 'This action cannot be undone.',
            saving: 'Saving...',
        },
        education: {
            verifyEducationTitle: 'Verify your education',
            verifyEducationDesc: 'Boost your credibility by verifying your educational background. Go to the Verifications section to submit your certificates or diplomas.',
            goToVerifications: 'Go to Verifications',
            gpaScale43: '4.3 Scale',
            gpaScale70: '7.0 Scale',
            gpaScale90: '9.0 Scale',
            gpaScale12: '12 Scale',
            gpaScale20: '20 Scale',
            gpaHint43: 'GPA on a 0.0 to 4.3 scale (eg: 3.9)',
            gpaHint50: 'Grade on a 0.0 to 5.0 scale (eg: 4.2)',
            gpaHint70: 'GPA on a 0.0 to 7.0 scale (eg: 6.5)',
            gpaHint90: 'CGPA on a 0.0 to 9.0 scale (eg: 8.2)',
            gpaHint10: 'Grade on a 0 to 10 scale (eg: 8.5)',
            gpaHint12: 'Grade on a 0 to 12 scale (eg: 10)',
            gpaHint20: 'Grade on a 0 to 20 scale (eg: 16)',
            gpaHint100: 'Percentage from 0 to 100 (eg: 85)',
        },
        experience: {
            verifyExperienceTitle: 'Verify your work experience',
            verifyExperienceDesc: 'Add credibility to your profile by verifying your work experience. Go to the Verifications section to submit documentation.',
            goToVerifications: 'Go to Verifications',
            positionRequired: 'Position is required',
            companyRequired: 'Company name is required',
            startDateRequired: 'Start date is required',
            endDateRequired: 'End date is required. If you still work here, check "I currently work here"',
            datesInvalid: 'The dates are not valid',
        },
        identity: {
            contactInfo: 'Contact Information',
            gender: 'Gender',
        ...
        languages: {
            ...
            haveCertificate: 'Do you have a language certificate?',
            uploadCertificateDesc: 'Upload official certificates (TOEFL, IELTS, DELE, DELF, etc.) to verify your proficiency.',
            uploadCertificate: 'Upload Certificate',
            whatIsNativeLanguage: 'What is your native language?',
            nativeLanguageDesc: 'Start by selecting your native language. This is the language you speak fluently from birth or early childhood.',
            ...
            addLanguage: 'Add Language',
            noAdditionalLanguages: 'No additional languages yet',
            proficiencyLevel: 'Proficiency Level',
            proficiencyPercentage: 'Proficiency Percentage (%)',
    ...
    preferencesToasts: {
        ...
        savedAutomatically: 'Preferences saved automatically',
        savedSuccessfully: 'Preferences saved successfully',
        errorSaving: 'Error saving preferences',
    },
    aiPremium: {
        premiumFeature: 'Premium Feature',
        premiumDescription: 'AI features to improve your profile are available on Basic, Pro and Enterprise plans.',
        whatsIncluded: 'What\'s included?',
        improveSummary: 'Automatic improvement of your professional summary',
        optimizeExperience: 'Optimization of experience descriptions',
        improveEducation: 'Improvement of education sections',
        ...
        remaining: 'remaining',
        checking: 'Checking...',
        mustBeLoggedIn: 'You must be logged in to use this feature',
        noAiAccess: 'You don\'t have access to AI features on your current plan',
        confirmApplyChanges: 'Confirm Apply Changes',
        originalText: 'Original Text',
        aiImprovedText: 'AI-Enhanced Text',
        confirmNote: 'This action will replace the current text with the AI-enhanced version. Changes will be applied immediately to your profile.',
        note: 'Note:',
        cancel: 'Cancel',
    ...
    aiSkillsSuggestion: {
        notAvailableTitle: 'Skill suggestions not available',
        notAvailableDesc: 'Add at least 1 work experience so AI can suggest relevant skills based on your professional background.',
        premiumFeature: 'Premium Feature',
        premiumSkillsDesc: (planName: string) => `AI-powered skill suggestions are available on Pro and Enterprise plans. Current plan: ${planName}`,
        autoSkillDetection: 'Automatic skill detection from your experience',
        industryRecommendations: 'Industry-relevant skill recommendations',
        oneClickAdd: 'One-click skill addition',
        upgradeToPro: 'Upgrade to Pro',
        aiRequestsRemaining: (count: number) => `${count} AI requests remaining this month`,
        getUnlimited: 'Get Unlimited',
        basedOnExperiences: (count: number) => `Based on your ${count} work experience(s)`,
        analyzingWithAi: 'Analyzing with AI...',
        limitReached: 'Limit Reached',
        regenerateSuggestions: 'Regenerate AI Suggestions',
        generateSuggestions: 'Generate AI Suggestions',
        needExperience: 'You need at least 1 work experience to get suggestions',
        added: 'Added',
        adding: 'Adding...',
        add: 'Add',
        analyzingExperiences: 'Analyzing your experiences...',
        aiIdentifyingSkills: 'AI is identifying relevant skills based on your professional background',
        noNewSkillsFound: 'No new skills found',
        noNewSkillsDesc: 'AI did not detect additional skills based on your current experiences. You can re-analyze later after adding more experiences.',
        tip: 'Tip:',
        tipText: 'These skills were automatically identified based on your experiences. Review and add the ones you truly master.',
    },
    aiTextOptimizer: {
        notAvailableTitle: 'AI suggestions not available',
        notAvailableDescExperience: 'Add at least 1 work experience with a description so AI can optimize it.',
        notAvailableDescEducation: 'Add at least 1 education with a description so AI can optimize it.',
        aiOptimization: 'AI Optimization',
        premiumFeature: 'Premium Feature',
        premiumOptimizeDescExperience: (planName: string) => `AI-powered experience optimization is available on Pro and Enterprise plans. Current plan: ${planName}`,
        premiumOptimizeDescEducation: (planName: string) => `AI-powered education optimization is available on Pro and Enterprise plans. Current plan: ${planName}`,
        transformDescriptions: 'Transform descriptions into impactful content',
        generateAchievements: 'Generate achievement bullet points',
        improveVisibility: 'Improve visibility with recruiters',
        upgradeToPro: 'Upgrade to Pro',
        aiRequestsRemaining: (count: number) => `${count} AI requests remaining this month`,
        getUnlimited: 'Get Unlimited',
        itemsToAnalyzeExperience: (count: number) => `${count} experience(s) to analyze`,
        itemsToAnalyzeEducation: (count: number) => `${count} education(s) to analyze`,
        analyzingWithAi: 'Analyzing with AI...',
        limitReached: 'Limit Reached',
        regenerateSuggestions: 'Regenerate AI Suggestions',
        generateSuggestions: 'Generate AI Suggestions',
        needItemExperience: 'You need at least 1 experience to get suggestions',
        needItemEducation: 'You need at least 1 education to get suggestions',
        noSuggestionsGenerated: 'Could not generate suggestions. Make sure you have descriptions in your records.',
        errorGenerating: 'Error generating suggestions. Please try again.',
        errorApplying: 'Error applying suggestion',
        analyzingWithAiLoading: 'Analyzing with AI...',
        optimizingDescriptions: 'Optimizing your descriptions to make them more impactful',
        originalDescription: 'Original Description:',
        originalAchievements: 'Original Achievements:',
        aiOptimizedDescription: 'AI-Optimized Description:',
        keyOptimizedAchievements: 'Key Optimized Achievements:',
        reject: 'Reject',
        acceptAndApply: 'Accept and Apply',
        changesApplied: 'Changes applied',
        rejected: 'Rejected',
        emptyStateText: 'Click "Generate Suggestions" to optimize your descriptions with AI',
        noTitle: 'No title',
    ...
    company: {
        ...
        jobPostingsManagement: {
            ...
            toasts: {
                ...
                publishSuccess: 'Job posting published successfully!',
                insufficientCredits: 'Insufficient credits. Please top up.',
                errorPublishing: 'Error publishing job posting',
                statusUpdated: 'Status updated',
                errorUpdatingStatus: 'Error updating status',
                deleted: 'Job posting deleted',
                errorDeleting: 'Error deleting job posting',
            },
        },
        createJobPosting: {
            ...
            toasts: {
                ...
                errorSaving: 'Error saving job posting',
                maxSalary: 'Maximum salary is 10,000,000',
            },
            salaryTip: 'Tip: Leave salary fields empty to show "To be negotiated" to candidates',
        },
        registrationPage: {
            alreadyRegistered: 'You already have a registered company. Redirecting to dashboard...',
    ...
    feed: {
        ...
        post: {
            ...
            achievementBanner: 'Professional Achievement',
        ...
        comments: {
            ...
            inputHint: 'Enter to post · Esc to cancel',
        ...
        report: {
            ...
            willReview: "We'll review this post.",
            reasonQuestion: 'What is the reason for reporting?',
        ...
        poll: {
            question: 'Question',
            questionPlaceholder: 'What is your opinion on...?',
            options: 'Options',
        ...
        event: {
            title: 'Event title',
            titlePlaceholder: 'e.g. React Meetup in Madrid',
            date: 'Date',
            time: 'Time',
            location: 'Location',
            locationPlaceholder: 'e.g. Google Campus Madrid',
            link: 'Link',
    ...
    stampBadges: {
        ...
        authenticatedBy: 'Verification authenticated by YourCVPassport',
    },
    translationProgress: {
        translating: 'Translating...',
    },
    ...
    aiProductPage: {
        heroTitle: 'AI that powers your professional profile',
        heroSubtitle: 'Transform your CV into an optimized professional tool with the power of artificial intelligence. Automatic improvement, smart suggestions and real-time quality analysis.',
        heroCta: 'Optimize my profile with AI',
        featuresTitle: 'AI Features',
        featuresSubtitle: 'Discover how AI improves every aspect of your professional CV',
        feature1Title: 'Description Optimization',
        feature1Description: 'AI analyzes and automatically improves your work experience descriptions to make them more impactful and professional, ATS-optimized.',
        feature1ExampleTitle: 'Example: Job Description',
        feature1Before: 'Worked on web development projects and helped the team with various tasks.',
        feature1After: 'Led full-stack development of 5+ enterprise web applications, implementing scalable architectures with React and Node.js that improved operational efficiency by 40%. Collaborated with cross-functional teams in agile methodology to deliver high-quality solutions.',
        feature2Title: 'Professional Summary Generation',
        feature2Description: 'Automatically generates a compelling professional summary that highlights your strengths, experience and unique value in 2-3 impactful paragraphs.',
        feature2ExampleTitle: 'Example: Professional Summary',
        feature2Before: 'Developer with programming experience. I like working in teams.',
        feature2After: 'Full-Stack Software Engineer with 5+ years of experience building scalable web applications for Fortune 500 companies. Specialized in React, Node.js and cloud architectures (AWS). Recognized for leading technical teams and delivering complex projects 30% faster than industry average, with a focus on clean code and best practices.',
        feature3Title: 'Skills Suggestions',
        feature3Description: 'Receive intelligent recommendations for technical and soft skills relevant to your industry and role, based on analysis of thousands of successful profiles.',
        feature3SuggestionsLabel: 'Suggestions based on your profile:',
        feature4Title: 'Quality Checklist',
        feature4Description: 'Real-time analysis of your CV quality with actionable recommendations to improve each section and increase your chances of success.',
        checklistItem1: 'Professional photo added',
        checklistItem2: 'ATS-optimized summary',
        checklistItem3: '3+ years of experience documented',
        checklistItem4: 'Add at least 2 certifications',
        checklistItem5: 'Include portfolio/GitHub links',
        profileQuality: 'Profile quality:',
        midCtaTitle: 'Try AI for free',
        midCtaDescription: 'Discover how artificial intelligence can transform your CV in minutes. No credit card required.',
        midCtaButton: 'Start now for free',
        testimonialsTitle: 'What our users say',
        testimonialsSubtitle: 'Thousands of professionals have transformed their CVs with our AI',
        testimonial1Name: 'Maria Garcia',
        testimonial1Role: 'Software Engineer',
        testimonial1Text: 'The AI transformed my CV into something truly professional. I received 3 job offers in the first two weeks after optimizing it.',
        testimonial2Name: 'Carlos Rodriguez',
        testimonial2Role: 'Product Manager',
        testimonial2Text: "The skills suggestions were amazing. I added competencies I didn't know were important for my industry and now I pass all ATS filters.",
        testimonial3Name: 'Ana Martinez',
        testimonial3Role: 'UX Designer',
        testimonial3Text: 'The quality checklist helped me identify exactly what was missing from my CV. In 30 minutes I had a complete and professional profile.',
        finalCtaTitle: 'Ready to optimize your profile with AI?',
        finalCtaSubtitle: 'Join thousands of professionals already using our AI to stand out in the job market',
        finalCtaButton: 'Start free now',
        finalCtaNote: 'No credit card required',
        beforeLabel: 'Before',
        afterLabel: 'After (with AI)',
    },
};
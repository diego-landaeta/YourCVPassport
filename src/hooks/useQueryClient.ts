...
export const queryKeys = {
  ...
  // CV Versions
  cvVersions: (profileId: string) => ['cv-versions', profileId] as const,
  cvVersion: (versionId: string) => ['cv-version', versionId] as const,
  cvVersionStats: (profileId: string) => ['cv-version-stats', profileId] as const,
};

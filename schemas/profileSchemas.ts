...
export const experienceSchema = z.object({
  ...
  achievements: z.array(z.string().max(100, 'Maximum 100 characters per achievement')).nullable().optional(),
...
export const certificationSchema = z.object({
  ...
  issuer: z.string().min(2, 'El emisor es obligatorio'), // Ej: "Google", "AWS", "Microsoft"
...
export const collaborationSchema = z.object({
  ...
  organization: z.string().min(2, 'La organización es obligatoria'),
  role: z.string().min(2, 'Tu rol es obligatorio'),

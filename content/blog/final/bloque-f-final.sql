-- ============================================================
-- Bloque F: Contenido Sectorial (Artículos #25-28)
-- Status: REVISADO Y CORREGIDO
-- Reviewed: 2026-02-23
-- Artículos: perfil-verificado-psicologo, cv-verificado-terapias-holisticas,
--            cv-innovacion-tecnologia, cv-educadores-formadores-online
-- ============================================================


-- ============================================================
-- ARTÍCULO 25
-- Título: Cómo crear un perfil profesional verificado si eres psicólogo
-- Slug:   perfil-verificado-psicologo
-- Lang:   es
-- Pub:    2026-05-13
-- ============================================================
...
-- ============================================================
-- ARTÍCULO 26
-- Título: CV verificado para profesionales de terapias holísticas y bienestar
-- Slug:   cv-verificado-terapias-holisticas
-- Lang:   es
-- Pub:    2026-05-15
-- ============================================================
INSERT INTO blog_posts (title, slug, summary, content, image_url, category, is_featured, published_at, meta_title, meta_description, lang) VALUES (
...
-- ============================================================
-- ARTÍCULO 27
-- Título: Cómo destacar tu formación en innovación y tecnología en tu CV
-- Slug:   cv-innovacion-tecnologia
-- Lang:   es
-- Pub:    2026-05-18
-- ============================================================
INSERT INTO blog_posts (title, slug, summary, content, image_url, category, is_featured, published_at, meta_title, meta_description, lang) VALUES (
...
-- ============================================================
-- ARTÍCULO 28
-- Título: CV para educadores y formadores online: guía de verificación profesional
-- Slug:   cv-educadores-formadores-online
-- Lang:   es
-- Pub:    2026-05-20
-- ============================================================
INSERT INTO blog_posts (title, slug, summary, content, image_url, category, is_featured, published_at, meta_title, meta_description, lang) VALUES (

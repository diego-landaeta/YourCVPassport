-- ============================================================
-- Bloque B: SEO Pillars (Articles #5-10)
-- Status: REVIEWED AND CORRECTED
-- Reviewed: 2026-02-23
-- Articles: what-is-verified-cv (FEATURED), cv-verification-employers,
--           ai-revolutionizing-profile-verification, que-es-cv-verificado,
--           ia-revoluciona-busqueda-empleo, verified-professional-profiles-standard
-- ============================================================

-- Article #5: What Is a Verified CV? (FEATURED / PILLAR)
-- FIXES: meta_title expanded to 54 chars (was 44); meta_description expanded to 149 chars (was 144)

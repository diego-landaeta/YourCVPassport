...
const ProfileEditorSidebar: React.FC<ProfileEditorSidebarProps> = ({
  ...
  const subsections: SubsectionItem[] = [
    {
      id: 'ai-assistant',
      label: isAIAvailable ? t.aiAssistant : `${t.aiAssistant} (No disponible)`,
      icon: (
      ...
      checkComplete: (p) => {
        // Considera completado si tiene experiencia, educación o habilidades (señal de que usó el asistente)
        return experiencesCount > 0 || educationCount > 0 || skillsCount > 0;
      },
    },
    {
      id: 'identity',

  ...
  return (
    <div className="space-y-3 group">
      ...
      <div className="relative">
        ...
        <div
          className={`relative rounded-2xl p-5 shadow-2xl overflow-hidden transition-all duration-300 transform ${
            isActive
        ...
        {filteredTemplates.map((template) => {
          ...
          return (
            <CardPreview
              ...
              isActive={profile?.template === template.id}
              profile={profile}
              shareUrl={shareUrl}
              userEmail={userEmail}
              qrCodeUrl={qrCodeUrl}
        ...
        <div className="inline-flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl shadow-lg">
          ...
          <div className="text-left">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400">
              Tu tarjeta de visita se sincroniza automáticamente con el estilo de tu CV cuando cambias de template
            </p>
          </div>
        </div>
      </div>

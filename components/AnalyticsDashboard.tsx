...
const AnalyticsDashboard: React.FC = () => {
    ...
    const weekData = [
        { day: 'Lun', visits: 45, label: 'Lunes' },
        { day: 'Mar', visits: 62, label: 'Martes' },
        { day: 'Mié', visits: 78, label: 'Miércoles' },
        { day: 'Jue', visits: 71, label: 'Jueves' },
        { day: 'Vie', visits: 95, label: 'Viernes' },
        { day: 'Sáb', visits: 83, label: 'Sábado' },
        { day: 'Dom', visits: 112, label: 'Domingo' }
    ];
    ...
    return (
        <div className="w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                {/* Card 1 - Total de Visitas - Blue Theme */}
                <div
                ...
                >
                    <p className="text-xs uppercase tracking-wider text-blue-100 font-semibold mb-3">Total de Visitas</p>
                    ...
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-blue-100 font-semibold">+17.6% vs mes anterior</span>
                    </div>
                </div>

                {/* Card 2 - Esta Semana - Purple Theme */}
                <div
                    ...
                    onMouseLeave={() => setHoveredCard(null)}
                >
                    <p className="text-xs uppercase tracking-wider text-purple-100 font-semibold mb-3">Esta Semana</p>
                    <p className="text-4xl font-bold text-white mb-2">
                        +156
                    </p>
                    <div className="flex items-center gap-1 text-sm">
                        <span className="text-purple-100 font-semibold">Últimos 7 días</span>
                    </div>
                </div>

                {/* Card 3 - Tiempo Promedio - Indigo Theme */}
                <div
                    ...
                    onMouseLeave={() => setHoveredCard(null)}
                >
                    <p className="text-xs uppercase tracking-wider text-indigo-100 font-semibold mb-3">Tiempo Promedio</p>
                    <p className="text-4xl font-bold text-white mb-2">
                        2:34
                    </p>
                    <div className="flex items-center gap-1 text-sm">
                        <span className="text-indigo-100 font-semibold">Minutos por sesión</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <div className="flex justify-between items-center mb-6">
                    <h3 className="text-sm font-semibold uppercase tracking-wider text-gray-700 dark:text-gray-300">Visitas en los últimos 7 días</h3>

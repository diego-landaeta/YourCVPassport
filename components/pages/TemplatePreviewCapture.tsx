    ...
    const templates = [
        ...
        },
        {
            ...
            data: {
                ...
                experiences: [
                    { id: '1', profile_id: '13', position: 'Senior UX Designer', company_name: 'Digital Products Studio', start_date: '2019-01-01', end_date: null, description: 'Diseño de interfaces para aplicaciones móviles y web. Research y testing con usuarios.', is_current: true, created_at: new Date().toISOString() }
                ],
                education: [{ id: '1', profile_id: '13', field_of_study: 'General', degree: 'Diseño Gráfico', institution_name: 'Escuela de Diseño Barcelona', start_date: '2012-09-01', end_date: '2016-06-01', description: null, created_at: new Date().toISOString() }],
        ...
        },
        {
            ...
            data: {
                ...
                experiences: [
                    { id: '1', profile_id: '14', position: 'Creative Director', company_name: 'Brand Agency Madrid', start_date: '2018-01-01', end_date: null, description: 'Dirección de equipo creativo de 15 personas. Desarrollo de estrategia de marca y campañas.', is_current: true, created_at: new Date().toISOString() }
                ],
                education: [{ id: '1', profile_id: '14', field_of_study: 'General', degree: 'Publicidad y Relaciones Públicas', institution_name: 'Universidad Complutense', start_date: '2008-09-01', end_date: '2012-06-01', description: null, created_at: new Date().toISOString() }],
        ...
        },
        {
            ...
            data: {
                ...
                experiences: [
                    { id: '1', profile_id: '15', position: 'Senior Associate', company_name: 'Bufete Internacional Madrid', start_date: '2016-01-01', end_date: null, description: 'Asesoramiento en fusiones y adquisiciones. Due diligence y negociación de contratos.', is_current: true, created_at: new Date().toISOString() }
                ],
                education: [{ id: '1', profile_id: '15', field_of_study: 'General', degree: 'Licenciatura en Derecho', institution_name: 'Universidad de Navarra', start_date: '2006-09-01', end_date: '2011-06-01', description: null, created_at: new Date().toISOString() }],
        ...
        },
        {
            ...
            data: {
                ...
                experiences: [
                    { id: '1', profile_id: '16', position: 'Cardiólogo', company_name: 'Hospital Universitario La Paz', start_date: '2015-01-01', end_date: null, description: 'Atención clínica de pacientes con arritmias. Implantación de marcapasos y desfibriladores.', is_current: true, created_at: new Date().toISOString() }
                ],

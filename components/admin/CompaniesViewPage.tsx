...
const CompaniesViewPage: React.FC = () => {
  ...
  const translations = {
    en: {
      ...
      subtitle: 'View all companies and their registration details',
    ...
    es: {
      ...
      subtitle: 'Visualiza todas las empresas y sus detalles de registro',
      ...
      <div className="bg-white dark:bg-dark-bg-secondary border-b border-gray-200 dark:border-dark-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-cv-blue/10 dark:bg-cv-blue/20 rounded-lg">
              <BuildingOfficeIcon className="w-5 h-5 text-cv-blue dark:text-blue-400" />
              <span className="font-semibold text-cv-blue dark:text-blue-400">{companies.length}</span>

...
-- =====================================================================================
-- SCRIPT 12: VERIFICATION SYSTEM
-- Fecha: 2025-11-27
-- Descripción: Crea tablas stamps y verification_attempts y trigger para verificación de email.
-- =====================================================================================
...
CREATE POLICY "Users can view their own stamps" ON public.stamps FOR SELECT USING (auth.uid() = profile_id);

DROP POLICY IF EXISTS "Users can create their own stamps" ON public.stamps;
CREATE POLICY "Users can create their own stamps" ON public.stamps FOR INSERT WITH CHECK (auth.uid() = profile_id);

DROP POLICY IF EXISTS "Users can update their own stamps" ON public.stamps;
CREATE POLICY "Users can update their own stamps" ON public.stamps FOR UPDATE USING (auth.uid() = profile_id);
...
CREATE POLICY "Users can create their own verification attempts" ON public.verification_attempts FOR INSERT WITH CHECK (auth.uid() = user_id);

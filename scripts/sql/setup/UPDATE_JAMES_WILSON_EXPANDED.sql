-- =====================================================
-- ACTUALIZAR JAMES WILSON - VERSIÓN EXPANDIDA
-- =====================================================
...
Mi misión es crear comunidades educativas más empáticas, inclusivas y emocionalmente inteligentes, donde tanto educadores como estudiantes puedan prosperar.',
    ...
    website = 'https://jameswilsonsel.com',
    linkedin_url = 'https://linkedin.com/in/jameswilson-sel',
    updated_at = NOW()
  WHERE id = v_user_id;

  RAISE NOTICE '✅ Perfil actualizado con plantilla elegant-minimal';
...
• Implementé programa de mentoría que emparejar a 60 jóvenes con mentores
...
Presentado en conferencia AERA 2019.',
  ...
  RAISE NOTICE '══════════════════════════════════════════════════';
  RAISE NOTICE 'Plantilla cambiada a: elegant-minimal (verde)';

-- ============================================================
-- FIX: Error 400 en página de detalle de vacante
-- ============================================================
-- Este script corrige el acceso a detalles de vacante
-- y crea las tablas/funciones necesarias
-- ============================================================
...
-- PASO 3: Crear función RPC para obtener detalle de vacante
...
-- PASO 4: Crear tabla job_posting_questions si no existe
...
-- PASO 5: Asegurar que columnas necesarias existan
DO $$
BEGIN

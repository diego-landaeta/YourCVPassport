-- ============================================================================
-- CORREGIR UUID DE MICHELLE CHANG - REIKI & ENERGY WORK
-- ============================================================================
-- UUID INCORRECTO (usado anteriormente): f30db5f9-0807-4d48-aa76-de4b6d7278da
-- UUID CORRECTO: b214d6b0-d516-4446-9d40-4b4bcd17678c
-- Email: michelle.chang@iseih.edu
-- ============================================================================

-- PASO 1: Eliminar datos existentes del UUID correcto (por si tiene datos residuales)
DELETE FROM public.portfolio_items WHERE profile_id = 'b214d6b0-d516-4446-9d40-4b4bcd17678c';
DELETE FROM public.skills WHERE profile_id = 'b214d6b0-d516-4446-9d40-4b4bcd17678c';
DELETE FROM public.experiences WHERE profile_id = 'b214d6b0-d516-4446-9d40-4b4bcd17678c';
...
('b214d6b0-d516-4446-9d40-4b4bcd17678c',
...
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Reiki Healing', 'EXPERT', 10, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Usui Reiki', 'EXPERT', 10, 'Specialization'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Energy Healing', 'EXPERT', 10, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Healing Touch', 'ADVANCED', 8, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Reiki Teaching', 'EXPERT', 8, 'Education'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Reiki Attunements', 'EXPERT', 8, 'Education'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Energy Assessment', 'ADVANCED', 10, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Chakra Balancing', 'ADVANCED', 9, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Holistic Wellness', 'ADVANCED', 10, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Complementary Therapy', 'EXPERT', 10, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Energy Medicine', 'ADVANCED', 9, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Stress Reduction', 'ADVANCED', 10, 'Specialization'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Relaxation Techniques', 'EXPERT', 10, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Patient Education', 'EXPERT', 10, 'Clinical Practice'),
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'Integrative Health', 'ADVANCED', 9, 'Clinical Practice');
...
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'CERTIFICATION', 'Usui Reiki Master/Teacher', 'International Center for Reiki Training', '2014-05-01'::date,
...
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'CERTIFICATION', 'Certified Healing Touch Practitioner', 'Healing Touch Program', '2016-03-01'::date,
...
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'CERTIFICATION', 'Energy Medicine Practitioner', 'Energy Medicine Institute', '2018-09-01'::date,
...
('b214d6b0-d516-4446-9d40-4b4bcd17678c', 'CERTIFICATION', 'Holistic Health Foundations', 'Prescott College', '2013-12-01'::date,
...
-- VERIFICACIÓN FINAL
SELECT
    'Michelle Chang - UUID CORREGIDO' as status,
    p.id as uuid,
...
WHERE p.id = 'b214d6b0-d516-4446-9d40-4b4bcd17678c';

#!/usr/bin/env bash
# One-shot: sube el avatar de Aleix Mabres Seoane al bucket profile-assets
# y actualiza profiles.avatar_url. Se ejecuta como user auth efímero y limpia al final.
#
# Uso:  bash scripts/upload-aleix-avatar.sh
# Requiere: .env.local con access token (sbp_...) VÁLIDO y VITE_SUPABASE_ANON_KEY.
#           C:\Users\nange\Downloads\WhatsApp Image 2026-08-17 at 12.52.14.jpeg presente.
...
echo "5/5 cleanup: OK"
echo ""
echo "==> Perfil: https://yourcvpassport.com/cv/aleix-mabres"

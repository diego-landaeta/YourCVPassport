#!/usr/bin/env bash
# One-shot: sube el avatar de Juan Pablo Rodríguez al bucket profile-assets
# y actualiza profiles.avatar_url. Se ejecuta como user auth efímero y limpia al final.
#
# Uso:  bash scripts/upload-juan-pablo-avatar.sh
# Requiere: .env.local con access token (sbp_...) y VITE_SUPABASE_ANON_KEY.
#           C:\Users\nange\Downloads\image (3).png presente.
...
# 4. UPDATE avatar_url en profiles del director
...
echo "5/5 cleanup: OK"
echo ""
echo "==> Perfil: https://yourcvpassport.com/cv/juan-pablo-rodriguez"
